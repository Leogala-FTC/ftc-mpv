-- FTC MVP - core application logic, seed data and RLS policies

-- Seed configuration singletons
...
-- Trigger: ensure profile & wallet on new auth user
...
-- Function: pay a payment session atomically
...
-- app_settings & topup_packs accessible to any logged user
